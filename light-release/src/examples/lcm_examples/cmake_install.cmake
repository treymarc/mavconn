# Install script for directory: /home/pixhawk/pixhawk/mavconn/src/examples/lcm_examples
...
IF(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "Unspecified")
  IF(EXISTS "$ENV{DESTDIR}/usr/local/bin/example-lcm-send" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/bin/example-lcm-send")
    FILE(RPATH_CHECK
         FILE "$ENV{DESTDIR}/usr/local/bin/example-lcm-send"
         RPATH "/usr/local/lib:/usr/local/lib")
  ENDIF()
  FILE(INSTALL DESTINATION "/usr/local/bin" TYPE EXECUTABLE FILES "/home/pixhawk/pixhawk/mavconn/light-release/bin/example-lcm-send")
  IF(EXISTS "$ENV{DESTDIR}/usr/local/bin/example-lcm-send" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/bin/example-lcm-send")
    FILE(RPATH_CHANGE
         FILE "$ENV{DESTDIR}/usr/local/bin/example-lcm-send"
    ...
    IF(CMAKE_INSTALL_DO_STRIP)
      EXECUTE_PROCESS(COMMAND "/usr/bin/strip" "$ENV{DESTDIR}/usr/local/bin/example-lcm-send")
...
IF(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "Unspecified")
  IF(EXISTS "$ENV{DESTDIR}/usr/local/bin/example-lcm-receive" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/bin/example-lcm-receive")
    FILE(RPATH_CHECK
         FILE "$ENV{DESTDIR}/usr/local/bin/example-lcm-receive"
         RPATH "/usr/local/lib:/usr/local/lib")
  ENDIF()
  FILE(INSTALL DESTINATION "/usr/local/bin" TYPE EXECUTABLE FILES "/home/pixhawk/pixhawk/mavconn/light-release/bin/example-lcm-receive")
  IF(EXISTS "$ENV{DESTDIR}/usr/local/bin/example-lcm-receive" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/bin/example-lcm-receive")
    FILE(RPATH_CHANGE
         FILE "$ENV{DESTDIR}/usr/local/bin/example-lcm-receive"
         ...
         NEW_RPATH "/usr/local/lib:/usr/local/lib")
    IF(CMAKE_INSTALL_DO_STRIP)
      EXECUTE_PROCESS(COMMAND "/usr/bin/strip" "$ENV{DESTDIR}/usr/local/bin/example-lcm-receive")
    ENDIF(CMAKE_INSTALL_DO_STRIP)
  ENDIF()
ENDIF(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "Unspecified")
...
IF(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "Unspecified")
  IF(EXISTS "$ENV{DESTDIR}/usr/local/bin/example-lcm-send-receive" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/bin/example-lcm-send-receive")
    FILE(RPATH_CHECK
         FILE "$ENV{DESTDIR}/usr/local/bin/example-lcm-send-receive"
         RPATH "/usr/local/lib:/usr/local/lib")
  ENDIF()
  FILE(INSTALL DESTINATION "/usr/local/bin" TYPE EXECUTABLE FILES "/home/pixhawk/pixhawk/mavconn/light-release/bin/example-lcm-send-receive")
  IF(EXISTS "$ENV{DESTDIR}/usr/local/bin/example-lcm-send-receive" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/bin/example-lcm-send-receive")
    FILE(RPATH_CHANGE
         FILE "$ENV{DESTDIR}/usr/local/bin/example-lcm-send-receive"
         ...
         NEW_RPATH "/usr/local/lib:/usr/local/lib")
    IF(CMAKE_INSTALL_DO_STRIP)
      EXECUTE_PROCESS(COMMAND "/usr/bin/strip" "$ENV{DESTDIR}/usr/local/bin/example-lcm-send-receive")
    ENDIF(CMAKE_INSTALL_DO_STRIP)
  ENDIF()
ENDIF(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "Unspecified")
