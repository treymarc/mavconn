# Install script for directory: /home/pixhawk/pixhawk/mavconn/src/calibration
...
IF(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "Unspecified")
  IF(EXISTS "$ENV{DESTDIR}/usr/local/bin/mavconn-cameracalibration-auto" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/bin/mavconn-cameracalibration-auto")
    FILE(RPATH_CHECK
         FILE "$ENV{DESTDIR}/usr/local/bin/mavconn-cameracalibration-auto"
         RPATH "/usr/local/lib:/usr/local/lib")
  ENDIF()
  FILE(INSTALL DESTINATION "/usr/local/bin" TYPE EXECUTABLE FILES "/home/pixhawk/pixhawk/mavconn/light-release/bin/mavconn-cameracalibration-auto")
  IF(EXISTS "$ENV{DESTDIR}/usr/local/bin/mavconn-cameracalibration-auto" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/bin/mavconn-cameracalibration-auto")
    FILE(RPATH_CHANGE
         FILE "$ENV{DESTDIR}/usr/local/bin/mavconn-cameracalibration-auto"
    ...
    IF(CMAKE_INSTALL_DO_STRIP)
      EXECUTE_PROCESS(COMMAND "/usr/bin/strip" "$ENV{DESTDIR}/usr/local/bin/mavconn-cameracalibration-auto")
...
IF(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "Unspecified")
  IF(EXISTS "$ENV{DESTDIR}/usr/local/lib/libcameracalibration.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/lib/libcameracalibration.so")
    FILE(RPATH_CHECK
         FILE "$ENV{DESTDIR}/usr/local/lib/libcameracalibration.so"
         RPATH "/usr/local/lib:/usr/local/lib")
  ENDIF()
  FILE(INSTALL DESTINATION "/usr/local/lib" TYPE SHARED_LIBRARY FILES "/home/pixhawk/pixhawk/mavconn/light-release/lib/libcameracalibration.so")
  IF(EXISTS "$ENV{DESTDIR}/usr/local/lib/libcameracalibration.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/lib/libcameracalibration.so")
    FILE(RPATH_CHANGE
         FILE "$ENV{DESTDIR}/usr/local/lib/libcameracalibration.so"
         ...
         NEW_RPATH "/usr/local/lib:/usr/local/lib")
    IF(CMAKE_INSTALL_DO_STRIP)
      EXECUTE_PROCESS(COMMAND "/usr/bin/strip" "$ENV{DESTDIR}/usr/local/lib/libcameracalibration.so")
    ENDIF(CMAKE_INSTALL_DO_STRIP)
  ENDIF()
ENDIF(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "Unspecified")
