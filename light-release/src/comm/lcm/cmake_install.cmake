# Install script for directory: /home/pixhawk/pixhawk/mavconn/src/comm/lcm
...
IF(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "Unspecified")
  IF(EXISTS "$ENV{DESTDIR}/usr/local/lib/libmavconn_lcm.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/lib/libmavconn_lcm.so")
    FILE(RPATH_CHECK
         FILE "$ENV{DESTDIR}/usr/local/lib/libmavconn_lcm.so"
         RPATH "/usr/local/lib:/usr/local/lib")
  ENDIF()
  FILE(INSTALL DESTINATION "/usr/local/lib" TYPE SHARED_LIBRARY FILES "/home/pixhawk/pixhawk/mavconn/light-release/lib/libmavconn_lcm.so")
  IF(EXISTS "$ENV{DESTDIR}/usr/local/lib/libmavconn_lcm.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/lib/libmavconn_lcm.so")
    FILE(RPATH_CHANGE
         FILE "$ENV{DESTDIR}/usr/local/lib/libmavconn_lcm.so"
    ...
    IF(CMAKE_INSTALL_DO_STRIP)
      EXECUTE_PROCESS(COMMAND "/usr/bin/strip" "$ENV{DESTDIR}/usr/local/lib/libmavconn_lcm.so")
