# Install script for directory: /home/pixhawk/pixhawk/mavconn/src/interface/camera
...
IF(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "Unspecified")
  IF(EXISTS "$ENV{DESTDIR}/usr/local/lib/libmavconn_cam.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/lib/libmavconn_cam.so")
    FILE(RPATH_CHECK
         FILE "$ENV{DESTDIR}/usr/local/lib/libmavconn_cam.so"
         RPATH "/usr/local/lib:/usr/local/lib")
  ENDIF()
  FILE(INSTALL DESTINATION "/usr/local/lib" TYPE SHARED_LIBRARY FILES "/home/pixhawk/pixhawk/mavconn/light-release/lib/libmavconn_cam.so")
  IF(EXISTS "$ENV{DESTDIR}/usr/local/lib/libmavconn_cam.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/lib/libmavconn_cam.so")
    FILE(RPATH_CHANGE
         FILE "$ENV{DESTDIR}/usr/local/lib/libmavconn_cam.so"
    ...
    IF(CMAKE_INSTALL_DO_STRIP)
      EXECUTE_PROCESS(COMMAND "/usr/bin/strip" "$ENV{DESTDIR}/usr/local/lib/libmavconn_cam.so")
...
IF(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "Unspecified")
  IF(EXISTS "$ENV{DESTDIR}/usr/local/bin/mavconn-camera" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/bin/mavconn-camera")
    FILE(RPATH_CHECK
         FILE "$ENV{DESTDIR}/usr/local/bin/mavconn-camera"
         RPATH "/usr/local/lib:/usr/local/lib")
  ENDIF()
  FILE(INSTALL DESTINATION "/usr/local/bin" TYPE EXECUTABLE FILES "/home/pixhawk/pixhawk/mavconn/light-release/bin/mavconn-camera")
  IF(EXISTS "$ENV{DESTDIR}/usr/local/bin/mavconn-camera" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/bin/mavconn-camera")
    FILE(RPATH_CHANGE
         FILE "$ENV{DESTDIR}/usr/local/bin/mavconn-camera"
         ...
         NEW_RPATH "/usr/local/lib:/usr/local/lib")
    IF(CMAKE_INSTALL_DO_STRIP)
      EXECUTE_PROCESS(COMMAND "/usr/bin/strip" "$ENV{DESTDIR}/usr/local/bin/mavconn-camera")
    ENDIF(CMAKE_INSTALL_DO_STRIP)
  ENDIF()
ENDIF(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "Unspecified")
...
IF(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "Unspecified")
  IF(EXISTS "$ENV{DESTDIR}/usr/local/lib/libmavconn_cam_opencv.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/lib/libmavconn_cam_opencv.so")
    FILE(RPATH_CHECK
         FILE "$ENV{DESTDIR}/usr/local/lib/libmavconn_cam_opencv.so"
         RPATH "/usr/local/lib:/usr/local/lib")
  ENDIF()
  FILE(INSTALL DESTINATION "/usr/local/lib" TYPE SHARED_LIBRARY FILES "/home/pixhawk/pixhawk/mavconn/light-release/lib/libmavconn_cam_opencv.so")
  IF(EXISTS "$ENV{DESTDIR}/usr/local/lib/libmavconn_cam_opencv.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/lib/libmavconn_cam_opencv.so")
    FILE(RPATH_CHANGE
         FILE "$ENV{DESTDIR}/usr/local/lib/libmavconn_cam_opencv.so"
         ...
         NEW_RPATH "/usr/local/lib:/usr/local/lib")
    IF(CMAKE_INSTALL_DO_STRIP)
      EXECUTE_PROCESS(COMMAND "/usr/bin/strip" "$ENV{DESTDIR}/usr/local/lib/libmavconn_cam_opencv.so")
    ENDIF(CMAKE_INSTALL_DO_STRIP)
  ENDIF()
ENDIF(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "Unspecified")
...
IF(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "Unspecified")
  IF(EXISTS "$ENV{DESTDIR}/usr/local/bin/mavconn-camera-opencv" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/bin/mavconn-camera-opencv")
    FILE(RPATH_CHECK
         FILE "$ENV{DESTDIR}/usr/local/bin/mavconn-camera-opencv"
         RPATH "/usr/local/lib:/usr/local/lib")
  ENDIF()
  FILE(INSTALL DESTINATION "/usr/local/bin" TYPE EXECUTABLE FILES "/home/pixhawk/pixhawk/mavconn/light-release/bin/mavconn-camera-opencv")
  IF(EXISTS "$ENV{DESTDIR}/usr/local/bin/mavconn-camera-opencv" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/bin/mavconn-camera-opencv")
    FILE(RPATH_CHANGE
         FILE "$ENV{DESTDIR}/usr/local/bin/mavconn-camera-opencv"
         ...
         NEW_RPATH "/usr/local/lib:/usr/local/lib")
    IF(CMAKE_INSTALL_DO_STRIP)
      EXECUTE_PROCESS(COMMAND "/usr/bin/strip" "$ENV{DESTDIR}/usr/local/bin/mavconn-camera-opencv")
    ENDIF(CMAKE_INSTALL_DO_STRIP)
  ENDIF()
ENDIF(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "Unspecified")
...
IF(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "Unspecified")
  IF(EXISTS "$ENV{DESTDIR}/usr/local/bin/mavconn-view" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/bin/mavconn-view")
    FILE(RPATH_CHECK
         FILE "$ENV{DESTDIR}/usr/local/bin/mavconn-view"
         RPATH "/usr/local/lib:/usr/local/lib")
  ENDIF()
  FILE(INSTALL DESTINATION "/usr/local/bin" TYPE EXECUTABLE FILES "/home/pixhawk/pixhawk/mavconn/light-release/bin/mavconn-view")
  IF(EXISTS "$ENV{DESTDIR}/usr/local/bin/mavconn-view" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/bin/mavconn-view")
    FILE(RPATH_CHANGE
         FILE "$ENV{DESTDIR}/usr/local/bin/mavconn-view"
         ...
         NEW_RPATH "/usr/local/lib:/usr/local/lib")
    IF(CMAKE_INSTALL_DO_STRIP)
      EXECUTE_PROCESS(COMMAND "/usr/bin/strip" "$ENV{DESTDIR}/usr/local/bin/mavconn-view")
    ENDIF(CMAKE_INSTALL_DO_STRIP)
  ENDIF()
ENDIF(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "Unspecified")
