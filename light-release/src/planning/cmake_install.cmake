# Install script for directory: /home/pixhawk/pixhawk/mavconn/src/planning
...
IF(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "Unspecified")
  IF(EXISTS "$ENV{DESTDIR}/usr/local/bin/mavconn-missionplanner-new" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/bin/mavconn-missionplanner-new")
    FILE(RPATH_CHECK
         FILE "$ENV{DESTDIR}/usr/local/bin/mavconn-missionplanner-new"
         RPATH "/usr/local/lib:/usr/local/lib")
  ENDIF()
  FILE(INSTALL DESTINATION "/usr/local/bin" TYPE EXECUTABLE FILES "/home/pixhawk/pixhawk/mavconn/light-release/bin/mavconn-missionplanner-new")
  IF(EXISTS "$ENV{DESTDIR}/usr/local/bin/mavconn-missionplanner-new" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/bin/mavconn-missionplanner-new")
    FILE(RPATH_CHANGE
         FILE "$ENV{DESTDIR}/usr/local/bin/mavconn-missionplanner-new"
    ...
    IF(CMAKE_INSTALL_DO_STRIP)
      EXECUTE_PROCESS(COMMAND "/usr/bin/strip" "$ENV{DESTDIR}/usr/local/bin/mavconn-missionplanner-new")
