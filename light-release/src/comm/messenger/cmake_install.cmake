# Install script for directory: /home/pixhawk/pixhawk/mavconn/src/comm/messenger
...
IF(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "Unspecified")
  IF(EXISTS "$ENV{DESTDIR}/usr/local/bin/mavconn-messenger" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/bin/mavconn-messenger")
    FILE(RPATH_CHECK
         FILE "$ENV{DESTDIR}/usr/local/bin/mavconn-messenger"
         RPATH "/usr/local/lib:/usr/local/lib")
  ENDIF()
  FILE(INSTALL DESTINATION "/usr/local/bin" TYPE EXECUTABLE FILES "/home/pixhawk/pixhawk/mavconn/light-release/bin/mavconn-messenger")
  IF(EXISTS "$ENV{DESTDIR}/usr/local/bin/mavconn-messenger" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/bin/mavconn-messenger")
    FILE(RPATH_CHANGE
         FILE "$ENV{DESTDIR}/usr/local/bin/mavconn-messenger"
    ...
    IF(CMAKE_INSTALL_DO_STRIP)
      EXECUTE_PROCESS(COMMAND "/usr/bin/strip" "$ENV{DESTDIR}/usr/local/bin/mavconn-messenger")
