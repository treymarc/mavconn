# Install script for directory: /home/pixhawk/pixhawk/mavconn/src/interface/shared_mem
...
IF(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "Unspecified")
  IF(EXISTS "$ENV{DESTDIR}/usr/local/lib/libmavconn_shm.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/lib/libmavconn_shm.so")
    FILE(RPATH_CHECK
         FILE "$ENV{DESTDIR}/usr/local/lib/libmavconn_shm.so"
         RPATH "/usr/local/lib:/usr/local/lib")
  ENDIF()
  FILE(INSTALL DESTINATION "/usr/local/lib" TYPE SHARED_LIBRARY FILES "/home/pixhawk/pixhawk/mavconn/light-release/lib/libmavconn_shm.so")
  IF(EXISTS "$ENV{DESTDIR}/usr/local/lib/libmavconn_shm.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/lib/libmavconn_shm.so")
    FILE(RPATH_CHANGE
         FILE "$ENV{DESTDIR}/usr/local/lib/libmavconn_shm.so"
    ...
    IF(CMAKE_INSTALL_DO_STRIP)
      EXECUTE_PROCESS(COMMAND "/usr/bin/strip" "$ENV{DESTDIR}/usr/local/lib/libmavconn_shm.so")
